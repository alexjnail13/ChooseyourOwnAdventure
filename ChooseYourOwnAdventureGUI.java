...
public class ChooseYourOwnAdventureGUI {
    public static void main(String[] args)
    {
        ...
        while(play)
        {
            ...
            do{
                ...
                choice1 = JOptionPane.showOptionDialog(null, "You are invited to go to third street during BGR by one of your friends","do you accept?", JOptionPane.DEFAULT_OPTION,JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
            ...
            {
                do{
                    String[] options = {"Sleep in", "Go to Class"};
                    choice2 = JOptionPane.showOptionDialog(null, "You have fun with your friends all night and get a few peoples instas but you are extremely tired the next morning when you have a 7:30 class.\nDo you want to sleep in and skip class or go to class tired",
                            "Third Street", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE,null, options, options[0]);
                ...
                else if(choice2 == 1)
                {
                    do {
                        ...
                        , "Lecture", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE,null,options,options[0]);
            ...
            if(choice1 == 1)
            {
                do{
                    ...
                    choice5 = JOptionPane.showOptionDialog(null, "One of your other friends offer to go to the corec and get a late night pump do you accept?",
                            "Co-Rec Pump?", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
                    if (choice5 == 0 || choice5 == 1){
                        input = true;
                    }
                    else {
                ...
                if(choice5 == 0)
                {
                    do{
                        ...
                        ,"Basketball?",JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null,options, options[0]);

                        if(choice6 == 0 || choice6 == 1)
                        {
                            input = true;
                        }
                        else{
                ...
                else if(choice5 == 1)
                {
                    do{
                        ...
                        , "Dance or Dorm?", JOptionPane.DEFAULT_OPTION,JOptionPane.QUESTION_MESSAGE, null, options, options[0]);


                        if(choice7 == 0 || choice7 == 1)
                        {
                            input = true;
                        }
                        else
